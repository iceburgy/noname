...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			"xinfu_pingcai_info":"出牌阶段限一次，你可以挑选一个宝物并擦拭掉其上面的灰尘。然后，你可以根据宝物类型执行对应的效果。（【卧龙】：对1名角色造成1点火焰伤害。若场上有存活的卧龙诸葛亮，则改为对至多2名角色各造成1点火焰伤害。【凤雏】：让至多3名角色进入铁索连环状态。若场上有存活的庞统，则改为让至多4名角色进入铁索连环状态。【水镜】：将1名角色装备区内的防具移动到另1角色对应区域。若场上有存活的司马徽，则改为将1名角色装备区内的1件装备移动到另1角色对应区域。【玄剑】：令1名角色摸一张牌并回复1点体力。若场上有存活的徐庶，则改为令1名角色摸一张牌并回复1点体力，然后庞德公摸一张牌。）",
			"xinfu_pdgyingshi":"隐世",
