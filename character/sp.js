		...
		skill:{
			...
			refuhan:{
				...
				content:function(){
					...
					var charcount=Math.max(4,game.countPlayer());
					var zhaoxiangindex=game.getCharacterIndex(player,'zhaoxiang');
					var othercharname=(zhaoxiangindex==0?player.name2:player.name1);
					list=game.getNextValidCharacters(othercharname,charcount,list);
					var skills=[];
					for(var i of list){
