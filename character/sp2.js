...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			sp_shenpei:'SP审配',
			gangzhi:'刚直',
			gangzhi_info:'锁定技，其他角色对审配造成的伤害，和审配对其他角色造成的伤害均视为体力流失。',
			beizhan:'备战',
			beizhan2:'备战',
			...
			re_panfeng:'潘凤',
			xinkuangfu:'狂斧',
			xinkuangfu_info:'出牌阶段限一次，你可以将任意角色装备区里的一张牌当【杀】使用（无视距离，不计次数）。若此【杀】不是你的牌且未造成伤害，你弃置两张手牌；若此【杀】是你的牌且造成了伤害，你摸两张牌。',
			xingdaorong:'邢道荣',
			xuxie:'虚猲',
			...
			re_sunluyu:'孙鲁育',
			remeibu:'魅步',
			remeibu_info:'其他角色的出牌阶段开始时，若你在其攻击范围内，你可以弃置一张牌，令该角色于本阶段内拥有〖止息〗。（锁定技，当你使用【杀】或普通锦囊牌时，你弃置一张手牌。）',
			rezhixi:'止息',
